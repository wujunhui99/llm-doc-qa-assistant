...
def build_chat_clients(cfg: Config) -> Dict[str, BaseChatClient]:
    ...
    # OpenAI / Claude / Ollama chat providers are all routed through LiteLLM adapters.
    ...
    clients["claude"] = ClaudeClient(
        api_base=(os.getenv("ANTHROPIC_API_BASE", "https://api.anthropic.com").strip() or "https://api.anthropic.com"),
